 ...
 */
open abstract class BaseAdapter1<D>(val context: Context, val list:List<D>, val layouts:SparseArray<Int>, var itemClick:IItemClick<D>):RecyclerView.Adapter<BaseAdapter1<D>.BaseVH>() {
